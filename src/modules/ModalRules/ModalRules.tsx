				...
				<ScrollView showsVerticalScrollIndicator={false}>
					<View className='mb-3 pb-3 border-b border-blueDark w-full'>
						<View className='items-center'>
							<AntDesign name='infocirlce' size={24} color='#074F57' />
						</View>
						<Text className='text-center text-xl font-robotoBold font-semibold '>
							Правила:
						</Text>
						<Text className='text-left text-md mt-3 font-roboto text-blueDark'>
					...
					<View className='mb-3 pb-3 border-b border-blueDark w-full'>
						...
						<Text className='text-center text-xl font-semibold font-robotoBold  text-blueDark'>
							Этапы:
						</Text>

						<Text className='text-md mt-3 font-roboto text-blueDark'>
						...
						<Text className='text-md mb-3 font-roboto text-redDark'>
						...
						<Text className='text-md mb-3 font-roboto text-blueDark'>
						...
						<Text className='text-md font-roboto text-blueDark'>
						...
						<Text className='text-md font-roboto text-redDark'>
							<Text className='font-robotoBold text-sm'> Запрещено: </Text>
					...
					<View className='pb-9'>
						<View className='items-center'>
							<FontAwesome5 name='award' size={24} color='#074F57' />
						</View>

						<Text className='text-center text-xl font-robotoBold  text-blueDark'>
							Цель:
						</Text>
